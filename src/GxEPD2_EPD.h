...
class GxEPD2_EPD
{
  public:
    ...
    virtual void writeImage(uint32_t bitmap, int16_t x, int16_t y, int16_t w, int16_t h, bool invert = false, bool mirror_y = false) {};
    ...
    virtual void writeImage(uint32_t black, uint32_t color, int16_t x, int16_t y, int16_t w, int16_t h, bool invert = false, bool mirror_y = false) {};
    ...
    virtual void writeImageAgain(uint32_t bitmap, int16_t x, int16_t y, int16_t w, int16_t h, bool invert = false, bool mirror_y = false)
    {
      // most controllers with differential update do switch buffers on refresh, can use:
    ...
    virtual void writeImagePartAgain(uint32_t bitmap, int16_t x_part, int16_t y_part, int16_t w_bitmap, int16_t h_bitmap,
  ...
  public:
    void _sram_init();
    uint32_t _sram_alloc(uint32_t amount);
    uint8_t _readByte(uint32_t addr);
    void _writeByte(uint32_t addr, uint8_t data);
  private:
    static uint32_t _sram_break;
};
